                                ...
                                foreach ($pendingLeaves as $pendLeaves) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tb-action text-right">
                                            <button type="button" onclick="approveShortLeave('<?php echo $pendLeaves->lv_id; ?>')" class="btn btn-sm btn-primary">Approve</button>
                                            <button type="button" onclick="rejectShortLeave('<?php echo $pendLeaves->lv_id; ?>')"  class="btn btn-sm btn-danger">Reject</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
            ...
            closeOnCancel: true
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        insert({
                            type: 'POST',
                            url: "<?php echo Yii::app()->baseUrl . '/Leave/ApproveLeave'; ?>",
                            data: {leaveId: id},
                ...
                closeOnCancel: true
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            insert({
                                type: 'POST',
                                url: "<?php echo Yii::app()->baseUrl . '/Leave/RejectLeave'; ?>",
