                                ...
                                foreach ($employeeData as $employee) {
                                    ...
                                    <tr class="ch_bx">
                                        ...
                                        foreach ($leaveTypes as $leaveType) {
                                            ...
                                            ?>
                                            <td>
                                                <input type="text" name="leave_<?php echo $leaveType->lt_id . '_' . $employee->emp_id; ?>" class="form-control" value="<?php echo count($leaveAllocation) > 0 ? $leaveAllocation->la_allocated_amount : ''; ?>"  />
                                            </td>
                                            <?php
                                        }
                                        ?>
                                        <td> <input type="text" name="firstSup_<?php echo $employee->emp_id; ?>" class="form-control" value="<?php echo count($firstSup) > 0 ? $firstSup->empno : ''; ?>" placeholder="EMP No" /></td>
                                        <td> <input type="text" name="secSup_<?php echo $employee->emp_id; ?>" class="form-control" value="<?php echo count($secondSup) > 0 ? $secondSup->empno : ''; ?>" placeholder="EMP No" /></td>
                                        <td> <input type="text" name="coverup_<?php echo $employee->emp_id; ?>" class="form-control" value="<?php echo count($coverup) > 0 ? $coverup->empno : ''; ?>" placeholder="EMP No" /></td>
                                        <?php
                                    }
                                    ?>
                            </tbody>
