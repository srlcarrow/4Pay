                ...
                <div class="content">
                    ...
                    <div class="row form-wrapper">
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="emp_name_with_initials"
                                       value="<?php echo $model->emp_name_with_initials; ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-wrapper">
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="emp_display_name"
                    ...
                    <div class="row form-wrapper">
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group">
                                <label>NIC</label>
                                <input type="text" name="emp_nic" value="<?php echo $model->emp_nic; ?>"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="con_permenant_add"
                                       value="<?php echo $contact->con_permenant_add; ?>" class="form-control" required>
                            </div>
                        </div>
                    ...
                    <div class="row form-wrapper">
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="con_mobile1" value="<?php echo $contact->con_mobile1; ?>"
                                       class="form-control number">
                            </div>
                        </div>
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="con_mobile2" value="<?php echo $contact->con_mobile2; ?>"
                                       class="form-control number">
                            </div>
                        </div>
                    </div>
